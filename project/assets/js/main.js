$(function() {
    ...
    var radiusScale = d3.scaleSqrt().domain([45, 50000]).range([1, 15]);
    ...
    init('data/number_sms_per_canton_per_hour.json');
    ...
    function ready(error, data) {
        ...
        var circles = svg.selectAll('circle')
            ...
            .on("mouseover", function(d, index) {
                ...
                div.html('Canton: ' + d.canton + '<br/>' + 'sms envoyés: ' + d.amount)
        ...
        function dimCircles(exception) {
            ...
            circles.style('opacity', function(d) {
                if (d.canton.toLowerCase() === exception)
                    return 1;
                return 0;
            });
        }
        ...
        $('.canton').on('click', function() {
            var canton = $(this);
            disableActiveCanton();
            var elementCanton = $(this).data().cantonprefix.toLowerCase();
